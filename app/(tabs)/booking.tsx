...
const styles = StyleSheet.create({
  ...
  scroll: { padding: 16 },
  heading: { color: '#1B5E20', fontSize: 26, fontWeight: '900', marginBottom: 16, letterSpacing: -0.5 },
  tabRow: { flexDirection: 'row', marginBottom: 16, gap: 8 },
  tabChip: {
    flex: 1, paddingVertical: 11, borderRadius: 50, backgroundColor: '#FFFFFF',
    alignItems: 'center', borderWidth: 1.5, borderColor: 'rgba(200,230,201,0.7)',
    shadowColor: 'rgba(76,175,80,0.12)', shadowOffset: { width: 0, height: 3 },
    shadowOpacity: 1, shadowRadius: 6, elevation: 3,
  },
  tabActive: { backgroundColor: '#4CAF50', borderColor: 'rgba(255,255,255,0.5)' },
  tabText: { color: '#558B2F', fontSize: 11, fontWeight: '700' },
  tabTextActive: { color: '#FFF', fontWeight: '800' },
  ticketCard: { marginBottom: 12 },
  ticketHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12 },
  ticketNum: { color: '#81C784', fontSize: 11 },
  ticketMode: { color: '#1B5E20', fontSize: 13, fontWeight: '800', flex: 1 },
  ...
  ticketCity: { color: '#1B5E20', fontSize: 18, fontWeight: '900' },
  ticketCountry: { color: '#558B2F', fontSize: 10 },
  ticketArrow: { flex: 1, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8 },
  ticketLine: { flex: 1, height: 1.5, backgroundColor: '#C8E6C9' },
  ticketFooter: { flexDirection: 'row', justifyContent: 'space-between' },
  ticketLabel: { color: '#558B2F', fontSize: 12 },
  ticketCost: { color: '#1B5E20', fontSize: 13, fontWeight: '800' },
  dottedLine: { borderTopWidth: 1, borderTopColor: '#C8E6C9', borderStyle: 'dashed', marginVertical: 10 },
  ...
  hotelCity: { color: '#1B5E20', fontSize: 16, fontWeight: '800' },
  hotelCost: { color: '#2E7D32', fontSize: 16, fontWeight: '900' },
  ...
  walletTitle: { color: '#1B5E20', fontSize: 16, fontWeight: '900', marginBottom: 12 },
  walletRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
  walletLabel: { color: '#558B2F', fontSize: 11 },
  walletValue: { color: '#1B5E20', fontSize: 22, fontWeight: '900' },
  ...
  sectionTitle: { color: '#558B2F', fontSize: 11, fontWeight: '800', letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 10, marginTop: 4 },
  ...
  memberShare: { color: '#2E7D32', fontSize: 16, fontWeight: '900' },
  docCard: { marginBottom: 10 },
  docRow: { flexDirection: 'row', gap: 16, marginTop: 10 },
  docItem: { flex: 1, backgroundColor: '#F0FAF1', borderRadius: 14, padding: 10, borderWidth: 1, borderColor: 'rgba(200,230,201,0.6)' },
