...
export const INDIA_LOCATIONS: Location[] = [
  {
    ...
    emoji: '🕌', tags: ['heritage', 'food', 'shopping'],
  ...
  },
  {
    ...
    emoji: '🕍', tags: ['heritage', 'romantic', 'UNESCO'],
  ...
  },
  {
    ...
    emoji: '🌙', tags: ['spiritual', 'pilgrimage', 'sufi'],
  ...
  },
  {
    ...
    emoji: '🏰', tags: ['heritage', 'culture', 'shopping'],
  ...
  },
  {
    ...
    emoji: '🌆', tags: ['metro', 'food', 'nightlife', 'beach'],
  ...
  },
  {
    ...
    emoji: '🏖️', tags: ['beach', 'nightlife', 'water sports'],
  ...
  },
  {
    ...
    emoji: '🌶️', tags: ['food', 'agriculture', 'local'],
  ...
  },
  {
    ...
    emoji: '🪔', tags: ['spiritual', 'pilgrimage', 'ghats'],
  ...
  },
  {
    ...
    emoji: '🌴', tags: ['backwaters', 'nature', 'culture'],
...
export const SINGAPORE_LOCATIONS: Location[] = [
  {
    ...
    emoji: '🌃', tags: ['iconic', 'luxury', 'views'],
  ...
  },
  {
    ...
    emoji: '🎢', tags: ['theme park', 'beach', 'resort'],
  ...
  },
  {
    ...
    emoji: '🏮', tags: ['culture', 'food', 'heritage'],
  ...
  },
  {
    ...
    emoji: '🛍️', tags: ['shopping', 'luxury', 'food'],
  ...
  },
  {
    ...
    emoji: '🪷', tags: ['culture', 'food', 'shopping'],
  ...
  },
  {
    ...
    emoji: '🍹', tags: ['nightlife', 'dining', 'riverside'],
  ...
  },
  {
    ...
    emoji: '💎', tags: ['shopping', 'nature', 'iconic'],
